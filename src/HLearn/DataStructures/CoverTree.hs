...
--         , weight                :: {-#UNPACK#-}!Float
        ...
        , children              :: {-#UNPACK#-}!(V.Vector (CoverTree' expansionRatio childContainer VU.Vector tag dp))
...
dist2level_up :: forall expansionRatio num. (KnownFrac expansionRatio, RealFrac num, Floating num) => Proxy expansionRatio -> num -> Int
